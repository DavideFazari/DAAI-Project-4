...
def main():
    ...
    parser.add_argument(
        "--input",
        default="~39347\\Desktop\\DAAI_Project\\eval\\Validation_Dataset\\FS_LostFound_full\\images\\*.png",
        nargs="+")
    
    
    ##DATASETS - PATHS 
    # here I report the paths of the validation datasets to be inserted in the arg.input
    ...
    parser.add_argument('--method', default='MSP') #method selection
    parser.add_argument('--T_scaling', default=1) #it is a boolean value indicating if the temperature scaling should be performed (1 = yes, 0 = no)
    parser.add_argument('--temperature', default=1.5) #temperature value for the scaling
